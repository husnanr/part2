...
<div class="container">
        <div class="row">
            <div class="col">
              <div style="opacity:0.8;" class="mt-4 p-5 bg-light text-dark rounded">
  ...
  <span class="visually-hidden">Loading...</span>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <!-- NAVIGASI MENU ADMIN  -->
                    <nav style="opacity:0.8;" class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <?php
                    if (isset($_GET['page'])) {
                        if ($_GET['page']== 'home') {
                            ...
                            echo"<br><center><h1>selamat datang  </h1></center></br> ";
                            echo"<br><center><h1> $nama </h1></center></br> ";
...
<?php
    ...
    ?>
    <script>
        window.location.href='http://localhost/15_mywebsite_12RPL2';
    </script>
    <?php
}
